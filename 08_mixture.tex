...
\item そこで各$x_i$について$q_{i,k} \mbox{ for } k=1,\ldots,K$という$\sum_k q_{i,k}=1$を満たす変数を用意する
\begin{align}
...
\end{align}
\begin{align}
\frac{\partial L(\{q_{i,k}\},\bm{\theta},\{\mu_k\},\{\sigma_k\})}{\partial q_{i,k}}
= \ln \big( \theta_k p(x_i | z_i = k) \big) - \ln q_{i,k} - 1 - \lambda_i
\end{align}
$\frac{\partial L(\{q_{i,k}\},\bm{\theta},\{\mu_k\},\{\sigma_k\})}{\partial q_{i,k}}$ = 0と$\sum_k q_{i,k}=1$より
...
\FontMath
\begin{align}
\frac{\partial L(\{q_{i,k}\},\bm{\theta},\{\mu_k\},\{\sigma_k\})}{\partial \theta_k}
= \sum_{i=1}^N \frac{ q_{i,k} }{ \theta_k } - \lambda_0
\end{align}
$\frac{\partial L(\{q_{i,k}\},\bm{\theta},\{\mu_k\},\{\sigma_k\})}{\partial \theta_k} = 0$と$\sum_k \theta_k = 1$より
